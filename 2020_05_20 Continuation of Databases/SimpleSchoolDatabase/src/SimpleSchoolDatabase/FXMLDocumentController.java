...
public class FXMLDocumentController implements Initializable {
    ...
    {        
        new School_StudentTable().updateStudent(Integer.parseInt(stu_id.getText()), stu_lname.getText(),
                                        stu_fname.getText(), stu_email.getText(), stu_phone.getText());
        fillTable();
        stu_id.clear();
        stu_lname.clear();
    ...
    {        
        new School_StudentTable().deleteStudent(Integer.parseInt(stu_id.getText()));
        fillTable();
        stu_id.clear();
        stu_lname.clear();
        stu_fname.clear();
